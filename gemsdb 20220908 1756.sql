...
--
-- Table structure for table `gfgc_gems`.`posts`
--
...
--
-- Dumping data for table `gfgc_gems`.`posts`
--
...
INSERT INTO `product` (`category`,`productname`,`productprice`,`quantity`,`image`,`description`,`discount`,`productid`,`storephone`,`gst`,`units`) VALUES 
 ('Ruby','diamonds','60000','600','bg.jpg','nice diamonds','0.3',14,'9965658585',NULL,NULL),
 ('Diamonds','pers','70000','800','9.jpg','nice perls','0.3',15,'9965658585','null',NULL),
 ('emerald','perls new','70000','48','8.jpg','nice perls','0.2',16,'9965658585','4',NULL);
...
--
-- Table structure for table `gfgc_gems`.`reply`
--
...
--
-- Dumping data for table `gfgc_gems`.`reply`
--
