...
<center>
<div align="center" class="style1"> User Registration </div>
<form id="form1" name="form1" method="get" action="AddCustomer.jsp">
  <table width="374" height="10" border="1" align="center">
    <tr>
      <td width="163"><p align="right" class="style11">email ID </p></td>
    ...
    <tr>
      <td><div align="right" class="style8"><span class="style6">Zip</span></div></td>
    ...
    <tr>
      <td><div align="right" class="style8"><strong>Enter a Question </strong></div></td>
      <td><textarea name="question" id="question"></textarea></td>
    </tr>
    <tr>
      <td><div align="right" class="style8"><strong>Answer the Question </strong></div></td>
