...
<div align="center">
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p class="style2">Dealer Login Page  </p>
</div>
<center>
<form id="form1" name="form1" method="get" action="">
  <table width="531" border="1" align="center">
    ...
    <tr>
     ...
     <a href="dealerReg.jsp"> <input type="button"  value="Register" /></a></td>
    </tr>
  </table>
...
rst=stmt.executeQuery("select * from dealer where phone='"+un+"' and password='"+pw+"'");
						if(rst.next()){
