...
try{
int x=stmt.executeUpdate("insert into feedback values('"+s1+"','"+s2+"')");
if(x!=0){
%>
<script>

alert("Feedback send Successfull");
window.open("sendfeedback.jsp","_self");
</script>
<%
}
